...
public class FutureValidationRule extends ValueValidationRule {
     ...
     */
    public static FutureValidationRuleBuilder builder(Function<?> function) {
        return new FutureValidationRuleBuilder(function);
    }

    FutureValidationRule(Function<?> valueFunction, String errorCode, Severity severity, String errorMessage, String valueName) {
